...
public class Crud extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jToggleButton1.setText("INGRESAR FICHA-PACIENTE");
        ...
        jToggleButton2.setText("REALIZAR PAGO DE CONSULTA");
        ...
        jToggleButton3.setText("CONSULTAR FICHA-PACIENTE");
        ...
        jToggleButton4.setFont(new java.awt.Font("Times New Roman", 1, 24)); // NOI18N
        jToggleButton4.setText("MOSTRAR FICHA-PACIENTES");
        ...
        jToggleButton5.setFont(new java.awt.Font("Times New Roman", 1, 24)); // NOI18N
        jToggleButton5.setText("ELIMINAR FICHA-PACIENTES");
        ...
        jToggleButton6.setFont(new java.awt.Font("Times New Roman", 1, 24)); // NOI18N
        jToggleButton6.setText("ACTUALIZAR FICHA-PACIENTE");
        ...
        ingreso.setLayout(new java.awt.CardLayout());
        jPanel2.add(ingreso, new org.netbeans.lib.awtextra.AbsoluteConstraints(423, 0, 510, 609));
    ...
    private void jToggleButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jToggleButton1ActionPerformed
          ingreso.add("P_ingreso",new P_ingreso());
          x.show(ingreso, "P_ingreso");
          ingreso.repaint();
          // TODO add your handling code here:
    }//GEN-LAST:event_jToggleButton1ActionPerformed

    private void jToggleButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jToggleButton2ActionPerformed
        ingreso.add("P_pagar",new P_pagar());
          x.show(ingreso, "P_pagar");
          ingreso.repaint();        // TODO add your handling code here:
    }//GEN-LAST:event_jToggleButton2ActionPerformed

    private void jToggleButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jToggleButton3ActionPerformed
       ingreso.add("P_consultar",new P_consultar());
          x.show(ingreso, "P_consultar");
          ingreso.repaint();   // TODO add your handling code here:
    }//GEN-LAST:event_jToggleButton3ActionPerformed

    private void jToggleButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jToggleButton4ActionPerformed
        ingreso.add("P_mostrar",new P_mostrar());
          x.show(ingreso, "P_mostrar");
          ingreso.repaint();   // TODO add your handling code here:
    }//GEN-LAST:event_jToggleButton4ActionPerformed

    private void jToggleButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jToggleButton5ActionPerformed
       ingreso.add("P_eliminar",new P_eliminar());
          x.show(ingreso, "P_eliminar");
          ingreso.repaint();   // TODO add your handling code here:
    }//GEN-LAST:event_jToggleButton5ActionPerformed

    private void jToggleButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jToggleButton6ActionPerformed
          ingreso.add("P_actualizar",new P_actualizar());
          x.show(ingreso, "P_actualizar");
          ingreso.repaint();     // TODO add your handling code here:
    }//GEN-LAST:event_jToggleButton6ActionPerformed

    private void jToggleButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jToggleButton7ActionPerformed
       ingreso.add("P_consultaPago",new P_ConsultarPagos());
          x.show(ingreso, "P_consultaPago");
          ingreso.repaint();  // TODO add your handling code here:
